...
CI uses the shared composite action (`.github/actions/build-and-package/`). Release inlines macOS steps (matrix build + lipo) to split work across runners for disk space.
