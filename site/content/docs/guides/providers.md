+++
title = "Providers"
description = "Included AI providers, available models, and how to configure your own custom providers."
date = 2026-02-10
weight = 4
...
Working from a source build? The repository's [developer docs](https://github.com/nightandwknd/asset-tap/blob/main/docs/DEVELOPMENT.md) cover mock mode, which exercises a provider config without spending credits.
...
- **Verify the config loads** (`--list-providers`) before testing against the real API to validate response parsing
