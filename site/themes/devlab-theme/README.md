...
[![Version](https://img.shields.io/badge/version-0.5.0-blue?style=flat-square)](https://codeberg.org/RiPetitor/devlab-theme/tags)
...
```sh
git clone --branch v0.5.0 --depth 1 https://codeberg.org/RiPetitor/devlab-theme themes/devlab-theme
```

Pinning the release tag keeps site builds reproducible. Change `v0.5.0` only when you intentionally upgrade the theme.
